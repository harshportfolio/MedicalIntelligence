		...
		<div class="container-fluid page-body-wrapper">
			<div class="row row-offcanvas row-offcanvas-right">
				...
				<div class="content-wrapper">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">Complain Table</h4>
							<div class="row">
								<div class="col-12">
									<div class="table-responsive">
										<table id="order-listing" class="table">
											...
											<tbody>
											<f:forEach items="${complainList}" var="i">
												<tr>
													<td>${i.complainId}</td>
                                                   ...
                                                   <td><a href="<%=request.getContextPath()%>/document/complain/${i.complaintFileName}">view</a></td>
                                                    ...
                                                    <td>
                                                    				<f:if test="${i.complaintStatus eq 'PENDING' }">
                                                    					<a href="replytoUser?complainId=${i.complainId}">reply</a>
                                                    				</f:if>
                                                    				<f:if test="${i.complaintStatus ne 'PENDING' }">
                                                    				RESOLVED
                                                    				</f:if>	
