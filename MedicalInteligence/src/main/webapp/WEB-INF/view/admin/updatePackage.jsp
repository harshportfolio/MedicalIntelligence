            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <f:form method="post" action="updatePackage" modelAttribute="packageVO">
                    <fieldset>
                      <div class="form-group">
                        <label for="cname">Package Name <sup><span style="color: red;">*</span></sup></label>
                        <f:input path="packageName"  class="form-control"  minlength="2" required="required"/>
                      </div>
                      <div class="form-group">
                        <label for="ccomment">Package Description <sup><span style="color: red;">*</span></sup></label>
                        <f:textarea class="form-control" path="packageDescription" required="required"></f:textarea> 
                      </div>
                      <div class="form-group">
                        <label for="cemail">Package Duration (in Years)<sup><span style="color: red;">*</span></sup></label>
                        <f:input path="packageDuration"  class="form-control" type="number" required="required"/>
                      </div>
                      <div class="form-group">
                        <label for="cemail">Package Price (in INR)<sup><span style="color: red;">*</span></sup></label>
                        <f:input path="packagePrice"  class="form-control" type="number" required="required"/>
                      </div>
