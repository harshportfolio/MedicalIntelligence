								...
								<div class="col-12">
									<div class="table-responsive">
										<table id="order-listing" class="table">
											...
											<tbody>
											<f:forEach items="${datasetList}" var="i">
												<tr>
													<td>${i.datasetId}</td>
													<td><a href="<%=request.getContextPath()%>/document/dataset/${i.datasetFileName}">VIEW</a></td>
													<td>${i.datasetDescription}</td>
													<td>
														<button class="btn btn-outline-primary"><a href="deleteDataset?id=${i.datasetId}">Delete</a></button>
													</td>
												</tr>
											</f:forEach>	
											</tbody>
